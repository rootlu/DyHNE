...
t1=clock;
bsb_data = ['./data/yelpWWWDynamic_lp/bsb_csr_0.mat'];
brurb_data = ['./data/yelpWWWDynamic_lp/brurb_csr_0.mat'];
...
save ./data/yelpWWWDynamic_lp/result/0_0.4bsb+0.6brurb_embedding.mat embedding;
...
for i = 1:10
    fprintf('Time step: %d  \n', i) 
    bsb_data = ['./data/yelpWWWDynamic_lp/bsb_csr_',int2str(i),'.mat'];
    brurb_data = ['./data/yelpWWWDynamic_lp/brurb_csr_',int2str(i),'.mat'];
    W_bsb = cell2mat(struct2cell(load(bsb_data)));
    W_brurb = cell2mat(struct2cell(load(brurb_data)));
    ...
    current_time_step_embs =  ['./data/yelpWWWDynamic_lp/result/',int2str(i),'_0.4bsb+0.6brurb_embedding.mat'];
